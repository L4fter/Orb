...
public class SingleShotWeapon : MonoBehaviour, IWeapon
{
    ...
    public WeaponType Type =>  new WeaponType(){Name = "SingleShot"};
...
[UsedImplicitly]
public class SingleShotWeaponFactory : ISingleWeaponFactory
{
    private readonly IResolver resolver;

    public SingleShotWeaponFactory(IResolver resolver)
    {
    ...
    private IWeapon FactoryFunc(IPlanet planet)
    {
        ...
        var weapon = planetView.gameObject.AddComponent<SingleShotWeapon>();
